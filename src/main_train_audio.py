...
def main():
    ...
    if hasattr(cfg, 'ensure_output_directories'):
        ...
        dirs_to_create = [
            ...
            cfg.AUDIO_REPORTS_FIGURES_DIR, cfg.AUDIO_REPORTS_METRICS_DIR,
        ]
    ...
    if RUN_TRAINING:
        run_audio_training_pipeline(
            ...
            num_test_files_per_class=cfg.AUDIO_NUM_TEST_FILES_PER_CLASS,
            epochs=cfg.AUDIO_EPOCHS,
            batch_size=cfg.AUDIO_BATCH_SIZE,
            learning_rate=cfg.AUDIO_LEARNING_RATE,
            ...
            test_files_list_path=cfg.AUDIO_TEST_FILES_LIST_PATH,
            training_history_plot_path=cfg.AUDIO_TRAINING_HISTORY_PLOT_PATH,
            confusion_matrix_val_plot_path=cfg.AUDIO_CONFUSION_MATRIX_VAL_PLOT_PATH,
            ...
            confusion_matrix_test_plot_path=cfg.AUDIO_CONFUSION_MATRIX_TEST_PLOT_PATH,
            detailed_test_results_path=cfg.AUDIO_DETAILED_TEST_RESULTS_PATH,
            predictions_save_path=cfg.AUDIO_PREDICTIONS_SAVE_PATH,
            true_labels_save_path=cfg.AUDIO_TRUE_LABELS_SAVE_PATH,
            class_names_save_path=cfg.AUDIO_CLASS_NAMES_SAVE_PATH
        )
    ...
    if RUN_TESTING:
        ...
        required_files_for_test = [
            ...
            cfg.AUDIO_SCALER_PATH, cfg.AUDIO_MAX_LEN_PATH, cfg.AUDIO_TEST_FILES_LIST_PATH
        ]
        if all(os.path.exists(f) for f in required_files_for_test):
            test_audio_model_on_saved_files( # Gọi hàm test trực tiếp từ main
                ...
                results_save_path=cfg.AUDIO_DETAILED_TEST_RESULTS_PATH,
                predictions_save_path=cfg.AUDIO_PREDICTIONS_SAVE_PATH,
                true_labels_save_path=cfg.AUDIO_TRUE_LABELS_SAVE_PATH,
                class_names_save_path=cfg.AUDIO_CLASS_NAMES_SAVE_PATH,
                confusion_matrix_save_path=cfg.AUDIO_CONFUSION_MATRIX_TEST_PLOT_PATH
            )
        else:
